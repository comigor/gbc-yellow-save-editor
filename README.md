...
- Progress smoke checks sample rendered bar pixels independently of percentage text, requiring low, half-full and near-full bars in every measured storage phase. A missing-fill mutation fails even with correct percentages and a successful save roundtrip.
